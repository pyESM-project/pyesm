...
def erase_folder(folder_path: str) -> None:
    """This function erases a folder and its content in a given path.
    ...
    if os.path.exists(folder_path):
        ...
        try:
            ...
            print(f'{folder_path} have been successfully erased.')
...
def generate_excel_headers(
    ...
    """This function generates an excel file with headers provided by a dictionary.
